		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "S4HANA UI Extension",
									"targetURL": "#S4HANAUIExtension-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"S4HANAUIExtension-display": {
								"semanticObject": "S4HANAUIExtension",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.sapui5extension",
									"url": sap.ui.require.toUrl("sap/btp/sapui5extension")
								}
							}
						}
					}
